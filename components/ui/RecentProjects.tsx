...
import { FaLocationArrow } from 'react-icons/fa'
 ...
 const RecentProjects = () => {
  ...
  <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10 p-4 pt-10 mt-10">
    {projects.map(({ id, title, des, img, iconLists, link }) => (
      <div key={id} className="flex items-center justify-center p-4">
        <PinContainer title={title} href={link}>
          <div className="relative flex items-center justify-center w-full overflow-hidden h-[30vh] sm:h-[25vh] mb-5">
          ...
          <div className="flex items-center justify-between mt-5 mb-2">
            ...
            <div className="flex items-center">
              <p className="text-sm text-purple">Case Study</p>
              <FaLocationArrow className="ms-3" color="#CBACF9" />
            </div>
          </div>
        </PinContainer>
